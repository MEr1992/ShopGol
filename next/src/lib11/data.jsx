...
const useData = () => {
    ...
    return {
        get: (url, component, itemName, callback) => Data.getInfo(url, component, itemName = 'info', callback = null, Lang),
        getInfo: (url, component, itemName , callback) => Data.getInfo(url, component, itemName = 'info', callback = null, Lang),
